...
- Each cycle: fetch/reset to remote, update the heartbeat stamp, commit,
  push. When the runner lives outside the repo, it is copied in first.
- A heartbeat stamp is only rewritten when the second actually changed, so
...
# last-run-utc = 2026-09-16T20:54:02Z
# <<< AUTOCOMMIT-HEARTBEAT <<<
